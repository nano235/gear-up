                    ...
                    <Form >
                        <div className={styles.container__form_container__form}>
                            <div className={styles.form_field}>
                                <InputField label='Current Password' placeholder='Enter current password' isPassword />
                            </div>
                            <div className={styles.form_field}>
                                <InputField label='New Password' placeholder='Enter new password' isPassword/>
                            </div>
                            <div className={styles.form_field}>
                                <InputField label='Confirm Password' placeholder='Repeat password' isPassword />
                            </div>
                        </div>
