...
const EditMember = ({ openModal, setOpenModal }: AddMemberProps) => {
    ...
    return (
        <Modal openModal={openModal} setOpenModal={onClose} title='Edit Member' description='Edit details of this Gearup member'>
