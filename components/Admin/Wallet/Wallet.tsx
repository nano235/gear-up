  ...
  return (
    <div className={styles.container}>
      <div className={styles.container__header_container}>
        <div className={`${styles.container__header_container__item} ${styles.left}`}>
          <div>
          ...
          <div className={styles.btn_container}>
            <Button buttonType='secondary' className={`${styles.transparent_btn} ${styles.btn}`}>
              <span className={styles.icon}><GridAddIcon className={styles.icon} /> </span>Deposit</Button>
        ...
        <>
          {
            isRequests ?
              <div className={`${styles.container__header_container__item} ${styles.pending_requests}`}>
                <div>
                  <p className={styles.title}>Withdrawal requests</p>
                  <h3 className={styles.description}>Review all pending withdrawal request</h3>
                </div>
                <Button buttonType='secondary' iconSuffix='/svgs/chevron2-right.svg' className={styles.pending_request_btn}>
              ...
              :
              <div className={`${styles.container__header_container__item} ${styles.no_requests}`}>
