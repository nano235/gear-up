		...
		<div className={styles.container}>
				...
				{cardsList.map(card => (
					<DashboardCard key={card.id}>
						<div className={styles.container__cards_container__item}>
							<div
								className={styles.container__cards_container__item__left}
							>
			...
			{isWithdrawal && (
				<WithdrawalModal
					...
					setIsWithdrawal={closeWithdrawalModal}
				/>
			)}
			{confirmWithdrawal && (
				<ConfirmWithdrawalModal
			...
			{showAlertModal && (
				<AlertModal openModal={showAlertModal} setOpenModal={setShowAlertModal} />
			)}
		</div>
	);
};
