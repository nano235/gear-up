                        ...
                        <>
                            <div className={styles.details_container}>
                                ...
                                <div>
                                    ...
                                    <p>
                                        Faults discovered! Inspection Summary: The Gearup-certified service center has completed a detailed inspection of the gear listed for a third-party check. Unfortunately, certain faults and issues have been identified during the assessment. Condition Assessment:
                                    </p>
                                </div>
                                <div>
                                    <h3>
